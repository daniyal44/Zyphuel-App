...
By downloading, installing, registering an account, or placing an order on the **Zyphuel** application, you ("User", "Customer", or "Rider") agree to be bound by these Terms and Conditions ("Terms"). If you do not agree to these Terms, do not use the application or services.
...
## 7. Driver / Rider Code of Conduct & Telematics
* Riders operate as independent logistics partners adhering to Zyphuel fleet safety standards.
* Riders agree to continuous GPS telematics logging during active delivery runs (`FOREGROUND_SERVICE_LOCATION`) for real-time safety monitoring and route optimization.
* Zero-tolerance policy for rash driving, tampering with fuel dispensers, or harassment.

---

## 8. Limitation of Liability
To the maximum extent permitted by applicable law in Pakistan:
* Zyphuel shall not be liable for indirect, incidental, or consequential damages resulting from vehicle mechanical breakdown, user negligence during handling of fuels, or third-party telecommunications outages.
* Total liability for any direct damage verified to have been caused by Zyphuel shall not exceed the total value of the specific order placed.
...
These Terms shall be governed by and construed in accordance with the laws of the **Islamic Republic of Pakistan**. Any dispute arising out of or related to these Terms shall be subject to the exclusive jurisdiction of the competent courts in **Lahore, Pakistan**.
